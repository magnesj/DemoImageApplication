...
/// 
//==================================================================================================
class PdmPointersFieldHandle : public PdmFieldHandle
{
public:
    PdmPointersFieldHandle()          {}
    virtual ~PdmPointersFieldHandle() {}

    virtual size_t      size() const = 0;
    virtual bool        empty() const = 0;
    virtual void        clear() = 0;
    virtual PdmObject*  createAppendObject(int indexAfter = -1) = 0;
    virtual void        insertAt(size_t indexAfter, PdmObject* obj) = 0;
    virtual void        erase(size_t index) = 0;
    virtual void        deleteAllChildObjects() = 0;
    virtual QString     containedClassKeyword() = 0;
...
template<typename DataType>
class PdmPointersField<DataType*> : public PdmPointersFieldHandle
{
    typedef DataType* DataTypePtr;
public:
    PdmPointersField()          { }
    ...
    virtual PdmObject*  createAppendObject(int indexAfter = -1);
    virtual void        insertAt(size_t indexAfter, PdmObject* obj);
    virtual QString     containedClassKeyword();
