...
void PdmUiTreeViewEditor::configureAndUpdateUi(const QString& uiConfigName)
{
    ...
    if (this->pdmItemRoot() && dynamic_cast<PdmObject*>(this->pdmItemRoot()))
    {
        dynamic_cast<PdmObject*>(this->pdmItemRoot())->objectEditorAttribute(uiConfigName, &m_editorAttributes);
    }
